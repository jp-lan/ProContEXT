'''
Author: 进泽
Date: 2022-11-07 18:57:02
LastEditors: 进泽
LastEditTime: 2022-11-17 17:24:32
Description: 
'''
import _init_paths
...
"""procontext"""
trackers.extend(trackerlist(name='procontext', parameter_name='procontext_got10k', dataset_name=dataset_name,
                            run_ids=None, display_name='ProContEXT'))
